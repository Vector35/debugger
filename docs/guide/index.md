...
| Windows user                         | Yes (Remote)                                            | Yes (Remote)                                            | Yes (Local/Remote)                                      |      |
| Windows PE (via wine)                | No                                                      | Yes (Local)                                             | No                                                      | [1]  |
| GDB Server                           | Yes                                                     | Yes                                                     | Yes                                                     |      |
| GDB RSP (QEMU/VMWare/Qiling/Android) | Yes                                                     | Yes                                                     | Yes                                                     |      |
| GDB Machine Interface                | [#170](https://github.com/Vector35/debugger/issues/170) | Yes (Local/Remote)                                      | [#170](https://github.com/Vector35/debugger/issues/170) |      |
