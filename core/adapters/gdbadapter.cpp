...
RemoteGdbAdapterType::RemoteGdbAdapterType(): DebugAdapterType("Corellium")
{
...
void RemoteGdbAdapterType::RegisterSettings()
{
	Ref<Settings> settings = Settings::Instance();
	settings->RegisterSetting("debugger.corellium.prefetch_reg_bytes",
	R"({
	...
	settings->RegisterSetting("debugger.corellium.prefetch_stack_bytes",
R"({
...
void BinaryNinjaDebugger::InitGdbAdapterType()
{
	...
	RemoteGdbAdapterType::RegisterSettings();
}
