...
{
	class CorelliumAdapter : public DebugAdapter
	{
	protected:
		struct RegisterInfo
		{
	...
	public:
		CorelliumAdapter(BinaryView* data, bool redirectGDBServer = true);
		~CorelliumAdapter();
	...
	class CorelliumAdapterType: public DebugAdapterType
	{
		static Ref<Settings> RegisterAdapterSettings();

	public:
		CorelliumAdapterType();
