 ...
 *
 * The inner package is exposed as an IStream - it is never written to a
 * temporary file - so the payload files go straight to destDir with no large
 * intermediate file to later delete.
 *
