...
{
	return controller->object->ReadMemory(address, size);
}
...
{
	std::vector<std::string> adapters = DebugAdapterType::GetAvailableAdapters();
	*count = adapters.size();
