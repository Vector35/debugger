...
| Windows user                         | Yes (Remote)                                            | Yes (Remote)                                            | Yes (Local/Remote)                                      | [Windows Remote setup](docs/guide/remote-debugging.md#windows-remote-debugging) |
...
**Notes:**
[1] Requires wine and winedbg. See [Wine Debugging Guide](docs/guide/wine-debugging.md) for setup instructions.
